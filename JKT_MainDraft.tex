...
{\huge Silicone Valley Episode 1: Stretchy Bois} % \huge sets the font size.  Other options include things like \large, \Large, \small, \tiny, etc.

\vspace{2cm}

{\large STARRING\\Jeremy K. Thaller}
