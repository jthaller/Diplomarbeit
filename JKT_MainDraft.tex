...
{\huge 10,000 ways not to say ``expired'' in Japanese: \\An Adhesion Based Measurement of \\\vspace{.2em} Strain-Dependent Surface Stress in Soft Solids} % \huge sets the font size.  Other options include things like \large, \Large, \small, \tiny, etc.
